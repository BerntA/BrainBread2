...
private:
	...
	CPanelAnimationVarAliasType(float, icon_wide, "icon_wide", "10", "proportional_float");
	CPanelAnimationVarAliasType(float, icon_height, "icon_height", "10", "proportional_float");
};
