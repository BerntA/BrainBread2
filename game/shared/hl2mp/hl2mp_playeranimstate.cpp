...
CHL2MPPlayerAnimState* CreateHL2MPPlayerAnimState( CHL2MP_Player *pPlayer )
{
	...
	movementData.m_flRunSpeed = 160.0f;
	movementData.m_flWalkSpeed = 70.0f;
...
#ifdef CLIENT_DLL
		BB2PlayerGlobals->BodyRestartGesture(GetHL2MPPlayer(), ACT_MP_KICK, 0);
#endif
		break;
	}
