...
#ifdef BB2_AI
		def.AddAmmoType("Remington700", DMG_BULLET, TRACER_LINE_AND_WHIZ, 40, BULLET_IMPULSE(1500, 8000), 7, 12);
		def.AddAmmoType("AK47", DMG_BULLET, TRACER_LINE_AND_WHIZ, 180, BULLET_IMPULSE(1200, 5000));
		def.AddAmmoType("Famas", DMG_BULLET, TRACER_LINE_AND_WHIZ, 200, BULLET_IMPULSE(2200, 7500));
		def.AddAmmoType("G36C", DMG_BULLET, TRACER_LINE_AND_WHIZ, 180, BULLET_IMPULSE(2000, 8000), 6, 10);
		def.AddAmmoType("Trapper", DMG_BULLET, TRACER_LINE_AND_WHIZ, 40, BULLET_IMPULSE(1300, 6000));
		def.AddAmmoType("Minigun", DMG_BULLET, TRACER_LINE_AND_WHIZ, 0, BULLET_IMPULSE(4000, 12500), 8, 14);
		def.AddAmmoType("MAC11", DMG_BULLET, TRACER_LINE_AND_WHIZ, 192, BULLET_IMPULSE(1500, 6000));
		def.AddAmmoType("MP7", DMG_BULLET, TRACER_LINE_AND_WHIZ, 240, BULLET_IMPULSE(1300, 4500));
		def.AddAmmoType("MP5", DMG_BULLET, TRACER_LINE_AND_WHIZ, 180, BULLET_IMPULSE(1500, 5500));
		def.AddAmmoType("Beretta", DMG_BULLET, TRACER_LINE_AND_WHIZ, 144, BULLET_IMPULSE(600, 2000));
		def.AddAmmoType("Glock17", DMG_BULLET, TRACER_LINE_AND_WHIZ, 153, BULLET_IMPULSE(850, 2400));
		def.AddAmmoType("Rex", DMG_BULLET, TRACER_LINE_AND_WHIZ, 36, BULLET_IMPULSE(800, 5000));
		def.AddAmmoType("Buckshot", DMG_BULLET | DMG_BUCKSHOT, TRACER_LINE, 32, BULLET_IMPULSE(800, 2000), 9, 15);
		def.AddAmmoType("RPG_Round", DMG_BURN, TRACER_NONE, 3, 0.0f, 10, 15);
		def.AddAmmoType("Grenade", DMG_BURN, TRACER_NONE, 3, 0.0f, 7, 12);
		def.AddAmmoType("Propane", DMG_BURN, TRACER_NONE, 1, 0.0f, 12, 16);
		def.AddAmmoType("Gravity", DMG_CLUB, TRACER_NONE, 8, 0.0f);
		def.AddAmmoType("Cannister", DMG_BURN, TRACER_NONE, 0, 0.0f);

		// func_tank related.
		def.AddAmmoType("AR2", DMG_BULLET, TRACER_LINE_AND_WHIZ, 90, BULLET_IMPULSE(200, 1225), 6, 10);
#endif //BB2_AI
	}
