...
#ifdef CLIENT_DLL
#define CWeaponWinchester94 C_WeaponWinchester94
#endif

class CWeaponWinchester94 : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS(CWeaponWinchester94, CBaseHL2MPCombatWeapon);
...
public:
	...
	CWeaponWinchester94(void);

private:
	CWeaponWinchester94(const CWeaponWinchester94 &);
};

IMPLEMENT_NETWORKCLASS_ALIASED(WeaponWinchester94, DT_WeaponWinchester94)

BEGIN_NETWORK_TABLE(CWeaponWinchester94, DT_WeaponWinchester94)
#ifdef CLIENT_DLL
...
#ifdef CLIENT_DLL
BEGIN_PREDICTION_DATA(CWeaponWinchester94)
...
LINK_ENTITY_TO_CLASS(weapon_winchester94, CWeaponWinchester94);
PRECACHE_WEAPON_REGISTER(weapon_winchester94);

acttable_t	CWeaponWinchester94::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponWinchester94);
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CWeaponWinchester94::FireNPCPrimaryAttack(CBaseCombatCharacter *pOperator, bool bUseWeaponAngles)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponWinchester94::Operator_ForceNPCFire(CBaseCombatCharacter *pOperator, bool bSecondary)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponWinchester94::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	switch (pEvent->event)
	{
...
void CWeaponWinchester94::AffectedByPlayerSkill(int skill)
{
	switch (skill)
	{
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponWinchester94::StartReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponWinchester94::Reload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponWinchester94::FinishReload(void)
{
	CBaseCombatCharacter *pOwner = GetOwner();
	if (pOwner == NULL)
		return;
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponWinchester94::FillClip(void)
{
	CBaseCombatCharacter *pOwner = GetOwner();
	if (pOwner == NULL)
		return;
...
//
//-----------------------------------------------------------------------------
void CWeaponWinchester94::DryFire(void)
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CWeaponWinchester94::PrimaryAttack(void)
{
...
//-----------------------------------------------------------------------------
void CWeaponWinchester94::ItemPostFrame(void)
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponWinchester94::CWeaponWinchester94(void)
{
...
void CWeaponWinchester94::StartHolsterSequence()
{
	if (m_bInReload)
		FinishReload();
...
bool CWeaponWinchester94::Holster(CBaseCombatWeapon *pSwitchingTo)
{
	m_bInReload = false;
	m_bShouldReloadEmpty = false;
...
void CWeaponWinchester94::Drop(const Vector &vecVelocity)
{
	m_bInReload = false;
	m_bShouldReloadEmpty = false;
