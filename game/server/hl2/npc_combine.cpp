...
int CNPC_Combine::OnTakeDamage(const CTakeDamageInfo &info)
{
...
void CNPC_Combine::FireBullets(const FireBulletsInfo_t &info)
{
...
int CNPC_Combine::AllowEntityToBeGibbed(void)
{
	if (m_iHealth > 0)
		return GIB_NO_GIBS;
