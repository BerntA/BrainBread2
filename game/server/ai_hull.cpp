...
ai_hull_t  Wide_Short_Hull		(bits_WIDE_SHORT_HULL,		"WIDE_SHORT_HULL",		Vector(-16,-16,   0),	Vector(16, 16, 24),		Vector(-16,-16, 0),	    Vector(16, 16, 24) );
...
ai_hull_t  Medium_Tall_Hull		(bits_MEDIUM_TALL_HULL,		"MEDIUM_TALL_HULL",		Vector(-19,-19,   0),	Vector(19, 19, 95),		Vector(-16,-16, 0),	    Vector(16, 16, 95) );
...
// Output :
//-----------------------------------------------------------------------------
Vector NAI_Hull::Bounds(int id, bool bSmall)
{
	const Vector &vMin = bSmall ? SmallMins(id) : Mins(id);
	const Vector &vMax = bSmall ? SmallMaxs(id) : Maxs(id);
	return (vMax - vMin);
}
