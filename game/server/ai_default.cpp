...
void CAI_BaseNPC::InitDefaultScheduleSR(void)
{
	...
	ADD_DEF_SCHEDULE("SCHED_MOVE_TO_TARGET", SCHED_MOVE_TO_TARGET);
	ADD_DEF_SCHEDULE("SCHED_MOVE_TO_TARGET_VITAL", SCHED_MOVE_TO_TARGET_VITAL);
...
//	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_NONE);
	...
	AI_LOAD_DEF_SCHEDULE(CAI_BaseNPC,					SCHED_MOVE_TO_TARGET);
	AI_LOAD_DEF_SCHEDULE(CAI_BaseNPC,					SCHED_MOVE_TO_TARGET_VITAL);
...
(
	...
	"	Tasks"
	"		TASK_SET_FAIL_SCHEDULE						SCHEDULE:SCHED_FEAR_FACE"
	"		TASK_STOP_MOVING							0"
	"		TASK_STORE_ENEMY_POSITION_IN_SAVEPOSITION	0"
	"		TASK_FIND_BACKAWAY_FROM_SAVEPOSITION		0"
	"		TASK_RUN_PATH								0"
...
(
	...
	"	Tasks"
	"		TASK_SET_FAIL_SCHEDULE	SCHEDULE:SCHED_MOVE_TO_TARGET" // Failed? Try again!
	"		TASK_RUN_PATH			0"
	"		TASK_WAIT_FOR_MOVEMENT	0"
	"		TASK_WAIT_PVS			0"
	""
