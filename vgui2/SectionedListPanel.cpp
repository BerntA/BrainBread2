...
//-----------------------------------------------------------------------------
// Purpose: Allow dynamic resizing of the list columns.
//-----------------------------------------------------------------------------
void SectionedListPanel::SetColumnWidthAtSection(int sectionID, int columnIndex, int iWidth)
{
	int index = FindSectionIndexByID(sectionID);
	if (index < 0)
		return;
	...
	m_Sections[index].m_Columns[columnIndex].m_iWidth = iWidth;
}
